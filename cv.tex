...
\begin{document}
  ...
  \begin{tabular}{rl}
    ...
    \textsc{Codeberg:}  & \href{https://codeberg.org/cmcmA20}{cmcmA20}                  \\
  ...
  \section{Work experience}
    \begin{longtable}{r|p{0.72\textwidth}}
      \textsc{Mar 2026--now} & \large \sffamily \textbf{Independent Researcher}                                                   \\
      \nopagebreak
      (currently (un)employed) & developing new approaches to mechanization of level-polymorphic categorical structures,
                                 see \href{https://hott-uf.github.io/2026/abstracts/HoTTUF_2026_paper_10.pdf}{HoTT/UF abstract}   \\
      \\&\\
      \textsc{Jul 2024--Mar 2026} & \large \sffamily \textbf{Senior Research Developer} at \textbf{Kaspersky Lab}, Russia   \\
      \nopagebreak
      (1 year, 9 months) & researched applications of polynomial functors                                                   \\
                         & researched wire formats and protocol specification languages                                     \\
      \\&\\
